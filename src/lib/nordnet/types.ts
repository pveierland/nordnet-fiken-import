export enum NordnetType {
  ...
  BYTTE_UTTAK_VP = 'BYTTE UTTAK VP',
  BYTTE_INNLEGG_VP = 'BYTTE INNLEGG VP',
  SPLITT_UTTAK_VP = 'SPLITT UTTAK VP',
  SPLITT_INNLEGG_VP = 'SPLITT INNLEGG VP',
  UTBYTTE = 'UTBYTTE',
}
